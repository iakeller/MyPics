...
define('text!modules/components/register.html', ['module'], function(module) { module.exports = "<template><center><div class=\"card\" style=\"width:600px\"><div class=\"card-body\"><h4 class=\"card-title\">Register for MyPics</h4><div id=\"errorMsg\" innerhtml.bind=\"loginError\"></div></div></div></center>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<center><div class=\"card\" style=\"width:600px\"><div class=\"card-body\"><form class=\"form-inline\"><form class=\"form-inline\"><input value.bind=\"user.firstName\" class=\"form-control\" id=\"firstName\" placeholder=\"First Name\"> &nbsp;  <input value.bind=\"user.lastName\" class=\"form-control\" id=\"lastName\" placeholder=\"Last Name\"></form>   &nbsp; &nbsp; &nbsp;<br><form class=\"form-inline\"><input value.bind=\"user.email\" type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"Email\"> &nbsp;&nbsp;&nbsp; <input value.bind=\"user.password\" type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\"></form><p></p></form><br>    <button type=\"button\" class=\"btn btn-primary\" click.trigger=\"save()\">Register</button></div></div>      </center>  </template>"; });
